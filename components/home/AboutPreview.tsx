      ...
      <div className="editorial-container">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="border border-[#0A4C38] bg-[#053827] p-6 max-w-xs relative">
          ...
          <div className="lg:col-span-7 space-y-6 text-base text-[#AFCDC1] font-sans leading-relaxed">
